...
\begin{cadre}{Facteur de qualité et bande passante}
	On a la relation suivante entre le facteur de qualité \(Q\) et la bande passante \(\Delta \omega\) :
		\[Q=\frac{\omega_0}{\Delta \omega}, \text{ avec } \omega_0 \text{ qui maximise le gain}\]
\end{cadre}
